...
<html>
<head>
<title>Poddar College of Technology and Management</title>
...
<h3 style="text-align: center;">
  <a href="index.php" style="color: white; text-align: center;">
	 ...
	 <div class="sap_tabs">	
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
			  <ul class="resp-tabs-list">
			  	  <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><div class="top-img" align="center"><img src="images/top-note.png" alt=""/></div><span>Register</span>
			  	  	
				</li>
				  <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><div class="top-img" align="center"><img src="images/top-lock.png" alt=""/></div><span>Login</span></li>
				  <!--
